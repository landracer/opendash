...
void app_main(void)
{
    ESP_LOGI(TAG, "OpenDash GPS / Telemetry Unit Starting...");
    ESP_LOGI(TAG, "Version: %s", OPENDASH_VERSION_STR);
    ESP_LOGI(TAG, "Node Type: OPENDASH_NODE_GPS");
    ...
    /* ────────────────────────────────────────────────────────────────────────
     * Step 3: Initialize GPS Module
     * ──────────────────────────────────────────────────────────────────────── */
    ESP_LOGI(TAG, "Initializing GPS module (LC76G)...");
    ESP_ERROR_CHECK(gps_handler_init());
    ESP_LOGI(TAG, "GPS module initialized");

    /* ────────────────────────────────────────────────────────────────────────
     * Step 4: Initialize IMU Sensor
     * ──────────────────────────────────────────────────────────────────────── */
    ...
    /* ────────────────────────────────────────────────────────────────────────
     * Step 5: Initialize Display Hardware
     * ──────────────────────────────────────────────────────────────────────── */
    ESP_LOGI(TAG, "Initializing display hardware...");
    ESP_ERROR_CHECK(display_init());
    ESP_LOGI(TAG, "Display hardware initialized (466×466 AMOLED)");
    ...
    ESP_LOGI(TAG, "OpenDash GPS / Telemetry Unit initialization complete");
    ESP_LOGI(TAG, "System ready - GPS acquiring, IMU active");
    ...
    while (1) {
        ...
        /* Future: Add I2C slave response handling, data logging */
    }
}
