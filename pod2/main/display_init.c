...
#define LVGL_DRAW_BUF_LINES 20   /* 20 lines per draw buffer — keeps SPI DMA bounce buffer in internal RAM */
...
static const co5300_lcd_init_cmd_t lcd_init_cmds[] = {
    ...
    {0x3A, (uint8_t[]){0x77}, 1, 0},    /* RGB888 pixel format (16.7M colors) */
...
static esp_err_t lcd_panel_init(void)
{
    ...
    spi_bus_config_t bus_config = {
        ...
        .max_transfer_sz = GPS_LCD_H_RES * LVGL_DRAW_BUF_LINES * 3,  /* Match draw buffer size for DMA */
...
static esp_err_t lvgl_init_direct(void)
{
    ...
    lv_display_set_color_format(lvgl_disp, LV_COLOR_FORMAT_RGB888);
    ...
    size_t buf_size = GPS_LCD_H_RES * LVGL_DRAW_BUF_LINES * 3;  /* RGB888: 3 bytes/pixel */
    ...
    /* Apply display rotation for physical mounting orientation (0/90/180/270°) */
#if DISPLAY_ROTATION_DEG == 90
    lv_display_set_rotation(lvgl_disp, LV_DISPLAY_ROTATION_90);
#elif DISPLAY_ROTATION_DEG == 180
    lv_display_set_rotation(lvgl_disp, LV_DISPLAY_ROTATION_180);
