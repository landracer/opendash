...
/* ────────────────────────────────────────────────────────────────────────────
 * I2C Slave — DEPRECATED (no longer used, kept for reference)
 * Left communicates with Center via ESP-NOW, not wired I2C.
 * GPIO16 is now used exclusively for GT911 touch INT.
 * ──────────────────────────────────────────────────────────────────────────── */
 ...
 * debounced press the task calls ui_manager_next_screen() under the LVGL
 * lock, cycling through the available display modes.
 *
 * Long-press (5 seconds) triggers the long-press callback if registered.
 *
...
/**
 * @brief Register a callback for boot button long-press (5 seconds).
 *
 * Used for odometer reset on the left gauge pod. When the user holds
 * the boot button for 5 seconds, the registered callback is invoked.
 *
 * @param callback  Function to call on long-press. NULL to clear.
 */
