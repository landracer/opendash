...
/* ────────────────────────────────────────────────────────────────────────────
 * Display Rotation — Compensate for physical mounting orientation.
 *
 * Set to 0, 90, 180, or 270 degrees clockwise.  Rotates the entire LVGL UI
 * so buttons, SD card slots, and USB ports end up in accessible positions.
 *
 * Override at build time:  idf.py build -DDISPLAY_ROTATION_DEG=180
 * Or change the default here for a permanent setting.
 * ──────────────────────────────────────────────────────────────────────────── */
#ifndef DISPLAY_ROTATION_DEG
#define DISPLAY_ROTATION_DEG  0   /* 0 = stock orientation */
#endif
