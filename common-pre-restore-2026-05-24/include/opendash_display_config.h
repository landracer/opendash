...
/**
 * @brief Pressure unit preference
 *
 * All internal pressure values are stored in kPa.
 * This setting controls display-side conversion only.
 */
typedef enum {
    OPENDASH_PRESSURE_KPA = 0,  /**< Kilopascals (kPa) — SI default */
    OPENDASH_PRESSURE_BAR = 1,  /**< Bar (1 bar = 100 kPa) */
    OPENDASH_PRESSURE_PSI = 2,  /**< Pounds per square inch (1 PSI ≈ 6.895 kPa) */
} opendash_pressure_unit_t;

/**
 * @brief Distance unit preference
 *
 * Used for odometer, trip meter, and navigation distances.
 */
typedef enum {
    OPENDASH_DISTANCE_KM = 0,   /**< Kilometers */
    OPENDASH_DISTANCE_MI = 1,   /**< Miles */
} opendash_distance_unit_t;
...
typedef struct {
    ...
    opendash_pressure_unit_t  pressure_unit;                    /**< Pressure display unit (kPa/BAR/PSI) */
    opendash_distance_unit_t  distance_unit;                    /**< Distance display unit (km/mi) */
