...
typedef enum {
    ...
    OPENDASH_NODE_RELAY_4CH   = 13, /**< 4-channel relay (HD) */
    OPENDASH_NODE_RELAY_8CH_A = 14, /**< 8-channel relay A */
    OPENDASH_NODE_RELAY_8CH_B = 15, /**< 8-channel relay B */
    OPENDASH_NODE_MOS_4CH_A = 16,   /**< 4-channel MOS FET controller A (default boost solenoid host) */
    OPENDASH_NODE_MOS_4CH_B = 17,   /**< 4-channel MOS FET controller B */
    OPENDASH_NODE_COUNT     = 18,   /**< Total number of node types */
    OPENDASH_NODE_INVALID   = 0xFF  /**< Sentinel: “no node selected / disabled” */
} opendash_node_t;
