...
/** Force-send (user-initiated safety command) total deadline: keep retrying a
 *  momentary TX-queue-full (ESP_ERR_ESPNOW_NO_MEM) up to this long before
 *  declaring failure. ~150ms is imperceptible for a deploy push yet easily
 *  outlasts a full Wi-Fi TX queue draining. */
#define CHANNEL_FORCE_SEND_DEADLINE_MS  150
