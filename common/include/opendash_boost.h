...
#define OPENDASH_BOOST_MAP_POINTS       32    /**< RPM points per gear map (2 UI pages × 16) */
#define OPENDASH_BOOST_UI_PAGE_SIZE     16    /**< Cells shown per editor page */
#define OPENDASH_BOOST_UI_PAGES         (OPENDASH_BOOST_MAP_POINTS / OPENDASH_BOOST_UI_PAGE_SIZE)
#define OPENDASH_BOOST_MODES            2     /**< NORMAL + RACE map slots */
#define OPENDASH_BOOST_RPM_MIN          0
#define OPENDASH_BOOST_RPM_MAX          16000 /**< Highest RPM in the map */
...
typedef enum {
    ...
    OPENDASH_BOOST_MODE_NORMAL = 1,  /**< Conservative low-boost map */
    OPENDASH_BOOST_MODE_RACE   = 2,  /**< Aggressive high-boost map */
} opendash_boost_mode_t;

/* Map slot index for the [mode] axis: NORMAL=0, RACE=1. */
#define OPENDASH_BOOST_SLOT_NORMAL  0
#define OPENDASH_BOOST_SLOT_RACE    1
...
typedef struct __attribute__((packed)) {
    ...
    uint8_t  output_mask;            /**< Bitmask of MOS channels (bit0=CH1..bit3=CH4) driving the N75(s) */
    uint8_t  reserved0[3];
...
#define OPENDASH_BOOST_PARAMS_VERSION  3
...
/** @brief Bitmask of MOS channels (bit0=CH1..bit3=CH4) the boost output drives.
 *  Cheap, lock-free read for the PWM task. */
