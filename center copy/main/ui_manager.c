...
static const display_mode_config_t mode_configs[DISPLAY_MODE_COUNT] = {
    ...
    [DISPLAY_MODE_GPS] = {
        .section_labels = {"ALTITUDE ft", "SAT COUNT", "HEADING \xc2\xb0", "LATITUDE", "HDOP", "ACCURACY"},
...
static const mode_dp_map_t mode_dp_maps[DISPLAY_MODE_COUNT] = {
    ...
    [DISPLAY_MODE_GPS] = {
        .section_dp = {
            ...
            OPENDASH_DP_LATITUDE,        /* [3] LATITUDE    */
            OPENDASH_DP_HDOP,            /* [4] HDOP        */
            OPENDASH_DP_LONGITUDE,       /* [5] ACCURACY    */
        },
...
void ui_manager_update_value(uint16_t data_point_id, float value)
{
    ...
    for (int i = 0; i < 6; i++) {
        ...
        if (data_point_id == OPENDASH_DP_LATITUDE ||
            data_point_id == OPENDASH_DP_LONGITUDE) {
            snprintf(buf, sizeof(buf), "%.5f", display_val);
        } else if (data_point_id == OPENDASH_DP_AFR ||
