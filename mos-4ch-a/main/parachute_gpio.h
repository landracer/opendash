 ...
 * @brief MOS-4CH-A — Parachute deploy output GPIO assignment.
 *
 ...
 *   MOS-A channels (from main.c mos_config):
...
#ifndef MOS_4CH_A_PARACHUTE_GPIO_H
#define MOS_4CH_A_PARACHUTE_GPIO_H
...
#endif /* MOS_4CH_A_PARACHUTE_GPIO_H */
